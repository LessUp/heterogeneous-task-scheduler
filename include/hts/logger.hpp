...
// Convenience macros
#define HTS_LOG_DEBUG(msg, ...) hts::Logger::instance().log(hts::LogLevel::Debug, msg, ##__VA_ARGS__)
#define HTS_LOG_INFO(msg, ...) hts::Logger::instance().log(hts::LogLevel::Info, msg, ##__VA_ARGS__)
#define HTS_LOG_WARN(msg, ...) hts::Logger::instance().log(hts::LogLevel::Warning, msg, ##__VA_ARGS__)
#define HTS_LOG_ERROR(msg, ...) hts::Logger::instance().log(hts::LogLevel::Error, msg, ##__VA_ARGS__)
