...
public:
    ...
    void task_created(TaskId id) {
        publish(Event{EventType::TaskCreated, id});
    }
    ...
    void graph_started() {
        publish(Event{EventType::GraphStarted});
    }
    
    void graph_completed() {
        publish(Event{EventType::GraphCompleted});
    }
    ...
    static const char* event_type_name(EventType type) {
        switch (type) {
            case EventType::TaskCreated: return "TaskCreated";
            ...
            case EventType::TaskRetrying: return "TaskRetrying";
            case EventType::GraphStarted: return "GraphStarted";
            case EventType::GraphCompleted: return "GraphCompleted";
            case EventType::MemoryAllocated: return "MemoryAllocated";
            case EventType::MemoryFreed: return "MemoryFreed";
            case EventType::StreamAcquired: return "StreamAcquired";
            case EventType::StreamReleased: return "StreamReleased";
...
private:
    ...
    std::unordered_map<EventType, std::vector<std::pair<SubscriptionId, EventHandler>>> handlers_;
