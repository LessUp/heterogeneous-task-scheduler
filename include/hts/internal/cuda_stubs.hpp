 ...
 *
 * When HTS_CPU_ONLY is defined, this header provides minimal stub implementations
 * of CUDA types and functions to allow the library to compile without CUDA.
 * This is intended for testing purposes only - the resulting library will NOT
 * have actual GPU functionality.
 */
