...
void run_with_policy(const std::string& name, std::unique_ptr<hts::SchedulingPolicy> policy) {
    ...
    std::cout << "CPU utilization: " << summary.cpu_utilization * 100 << "%" << std::endl;
    std::cout << "GPU utilization: " << summary.gpu_utilization * 100 << "%" << std::endl;
    std::cout << std::endl;
}
