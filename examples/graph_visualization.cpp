...
int main() {
    ...
    std::cout << "Created task graph with " << scheduler.graph().size() << " tasks" << std::endl;
    std::cout << std::endl;
    ...
    // Save JSON to file
    if (hts::GraphSerializer::save_to_file(scheduler.graph(), "task_graph.json")) {
    ...
    // Save DOT to file
    if (hts::GraphSerializer::save_dot_file(scheduler.graph(), "task_graph.dot")) {
        std::cout << "Saved DOT to task_graph.dot" << std::endl;
        std::cout << "To visualize: dot -Tpng task_graph.dot -o task_graph.png" << std::endl;
    }
