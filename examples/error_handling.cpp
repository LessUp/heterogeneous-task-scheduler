...
int main() {
    ...
    scheduler.set_error_callback([&](hts::TaskId id, const std::string &msg) {
        ...
        std::cout << "ERROR CALLBACK: Task " << id << " failed: " << msg << std::endl;
    });
    ...
    std::cout << "Task 3 ran: " << (task3_ran ? "yes" : "no") << " (should be blocked)"
              << std::endl;
    std::cout << "Task 4 ran: " << (task4_ran ? "yes" : "no") << std::endl;

    std::cout << std::endl;
    std::cout << "Task states:" << std::endl;
    std::cout << "  Task 1: " << static_cast<int>(task1->state()) << " (Completed=4)" << std::endl;
    std::cout << "  Task 2: " << static_cast<int>(task2->state()) << " (Failed=5)" << std::endl;
    std::cout << "  Task 3: " << static_cast<int>(task3->state()) << " (Blocked=6)" << std::endl;
    std::cout << "  Task 4: " << static_cast<int>(task4->state()) << " (Completed=4)" << std::endl;
