...
local and CI environments that lack CUDA hardware, including regression coverage for shared runtime
core modules and task/runtime seam behavior used across build modes.
